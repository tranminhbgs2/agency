...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rule = [
            ...
            'bank_account.*' => 'exists:bank_accounts,id',
        ];
    ...
    public function messages()
    {
        return [
            ...
            'bank_account.required' => 'Tài khoản ngân hàng không được để trống',
            'bank_account.*.exists' => 'Tài khoản ngân hàng không tồn tại',
        ];
    }
